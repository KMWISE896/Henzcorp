/*
  # Permanent Email Confirmation Fix
  
  This migration permanently disables email confirmation requirements
  and ensures all new users are automatically verified.
*/

-- Update the auth trigger to automatically mark emails as confirmed
...
BEGIN
  -- Automatically mark email as confirmed for new users
  UPDATE auth.users 
...
SELECT 'Permanent email confirmation fix applied!' as status;